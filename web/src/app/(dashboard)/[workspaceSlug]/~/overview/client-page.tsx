        ...
        <div className="flex flex-col gap-4">
            <div className='flex flex-col'>
                ...
                {currentWorkspace.ownerId === session?.user.id || (currentMembership.role === "OWNER" || currentMembership.role === "ADMIN") ?
                    (
                        <p className="text-xs text-zinc-500 dark:text-zinc-400">Get an overview of your workspace.</p>
                    ) : (
                        <p className="text-xs text-zinc-500 dark:text-zinc-400">You are a member of this workspace. Have an overview of the workspace.</p>
                    )}
