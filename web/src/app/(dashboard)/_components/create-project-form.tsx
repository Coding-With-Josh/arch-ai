              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    {form.getValues("description") || "None"}
                  </div>
                  <div>
                    <span className="font-semibold">Project Type: </span>
                    {form.getValues("projectType") === "HACKATHON" ? "Hackathon" : "Standard"}
                  </div>
                  <div>
                    <span className="font-semibold">Timeline: </span>
                    {form.getValues("startDate") 
                      ? `${format(form.getValues("startDate"), "PPP")} to ${format(form.getValues("endDate"), "PPP")}`
                      : "Not specified"}
                  </div>
                  ...
                  {isHackathon && (
                    <>
                      <div>
                        ...
                        {form.getValues("hackathonDetails.hackathonName") || "None"}
                      </div>
                      <div>
                        <span className="font-semibold">Registration Deadline: </span>
                        {form.getValues("hackathonDetails.registrationDeadline") 
                          ? format(form.getValues("hackathonDetails.registrationDeadline"), "PPP")
                          : "Not specified"}
                      </div>
                      <div>
                        <span className="font-semibold">Categories: </span>
                        {hackathonCategories.length > 0 
                          ? hackathonCategories.join(", ") 
                          : "None"}
                      </div>
                    </>
                  )}
                    ...
                    {milestones.length > 0 
                      ? milestones.map((m: any, i: number) => (
                          <div key={i} className="ml-4">
                            {i+1}. {m.name} - {format(m.dueDate, "PPP")}
                            {m.isHackathonPhase && ` (${m.phaseType})`}
                          </div>
                        ))
                      : "None"}
                  </div>
